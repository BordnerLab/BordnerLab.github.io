...
var pointLayers = [
	['C', 'Cemetery', 'Cpoint'],
	['CF', 'Cheese Factory', 'CFpoint'],
	['CH', 'Church', 'CHpoint'],
	['CR', 'Cannery', 'CRpoint'],
	['E', 'Erosion', 'Epoint'],
	['F/G', 'Filling Station/Garage', 'F/Gpoint'],
	['FB', 'Farm', 'FBpoint'],
	['FF', 'Fur Farm', 'FFpoint'],
	['FT', 'Fire Tower', 'FTpoint'],
	['GC', 'Golf Course', 'GCpoint'],
	['GL', 'Grist Mill', 'GLpoint'],
	['GP', 'Gravel Pit', 'GPpoint'],
	['H', 'Hotel', 'Hpoint'],
	['O', 'Orchard', 'Opoint'],
	['OH', 'Occupied House', 'OHpoint'],
	['OSCH', 'Occupied School', 'OSCHpoint'],
	['Qu', 'Quarry', 'Qupoint'],
	['S', 'Store', 'Spoint'],
	['SH', 'Summer House', 'SHpoint'],
	['SL', 'Saw Mill', 'SLpoint'],
	['SP', 'Spring', 'SPpoint'],
	['T', 'Tavern', 'Tpoint'],
	['TH', 'Townhall', 'THpoint'],
